...
describe('Fuzzy Matching System', () => {
  ...
  describe('Priority Type Bonuses', () => {
    it('should calculate priority bonuses correctly', () => {
      ...
      const withPriority = manager.calculateScore(classNode, 75, { priorityType: 'class' as NodeType })
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle queries longer than names', () => {
      ...
      const score = manager.calculateFuzzyScore('User', 'UserServiceMethodThatDoesNotExist', options)
